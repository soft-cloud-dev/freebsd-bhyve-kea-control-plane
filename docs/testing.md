...
This layer does not call real FreeBSD services, `vm-bhyve`, ZFS, PF, Kea, BIND, PostgreSQL, Stork, Prometheus, or Grafana. It statically validates the BIND listener and recursion boundary, Stork source pin, loopback agent/exporter bindings, database bootstrap, and startup readiness contract.
