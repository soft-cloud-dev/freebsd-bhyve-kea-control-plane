...
configure-services:
	@EXT_IF="${EXT_IF}" MGMT_IF="${MGMT_IF}" LAN_IF="${LAN_IF}" MGMT_NET="${MGMT_NET}" LAN_NET="${LAN_NET}" MGMT_ADDR="${MGMT_ADDR}" KEA_API_USER="${KEA_API_USER}" KEA_API_USER_FILE="${KEA_API_USER_FILE}" KEA_API_PASSWORD_FILE="${KEA_API_PASSWORD_FILE}" POSTGRES_EXPORTER_DSN="${POSTGRES_EXPORTER_DSN}" sh scripts/configure_services.sh
